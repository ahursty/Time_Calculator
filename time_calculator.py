def add_time(start, duration, day_of_week=False):
    # Create days of the week dictionary to read input day
    days_of_the_week_index = {"monday": 0, "tuesday": 1, "wednesday": 2, "thursday": 3, "friday": 4, "saturday": 5,
                              "sunday": 6}

    # Create days of the week array to handle output text, which needs capitalized day of week
    days_of_the_week_array = ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"]

    # Use partition to split duration into tuple with 3 elements
    ...
    am_or_pm = am_and_pm_switch[am_or_pm] if amount_of_am_pm_flips % 2 == 1 else am_or_pm
